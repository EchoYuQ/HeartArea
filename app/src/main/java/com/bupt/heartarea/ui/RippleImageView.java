...
//                    break;
    ...
    private void getAttributeSet(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.bupt.heartarea.R.styleable.custume_ripple_imageview);

        show_spacing_time = typedArray.getInt(com.bupt.heartarea.R.styleable.custume_ripple_imageview_show_spacing_time, SHOW_SPACING_TIME);
        imageViewWidth = typedArray.getDimension(com.bupt.heartarea.R.styleable.custume_ripple_imageview_imageViewWidth, IMAMGEVIEW_SIZE);
        imageViewHeigth = typedArray.getDimension(com.bupt.heartarea.R.styleable.custume_ripple_imageview_imageViewHeigth, IMAMGEVIEW_SIZE);
    ...
    private void setLayout(Context context) {
        ...
        for (int i = 0; i < SIZE; i++) {
            ...
            imgs[i].setImageResource(com.bupt.heartarea.R.drawable.kaishiceliang);
        ...
        img_bg.setImageResource(com.bupt.heartarea.R.drawable.kaishiceliang);
