...
import com.bupt.heartarea.utils.ViewUtils;
...
public class BaseCircle extends View {
    ...
    public BaseCircle(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCircleBackground = getResources().getColor(com.bupt.heartarea.R.color.circle_background);
        mCircleGray = getResources().getColor(com.bupt.heartarea.R.color.circle_gray);
        mCircleGreen = getResources().getColor(com.bupt.heartarea.R.color.circle_green);

        mDividerWidth = (int) getResources().getDimension(com.bupt.heartarea.R.dimen.divider_width);
        mOutIndicatorSize = (int) getResources().getDimension(com.bupt.heartarea.R.dimen.out_indicator_size);
        mTitleSize = (int) getResources().getDimension(com.bupt.heartarea.R.dimen.title_indicator_size);
        mContentSize = (int) getResources().getDimension(com.bupt.heartarea.R.dimen.content_indicator_size);
        mUnitSize = (int) getResources().getDimension(com.bupt.heartarea.R.dimen.unit_indicator_size);
        mAlertSize = (int) getResources().getDimension(com.bupt.heartarea.R.dimen.alert_indicator_size);

        mCenterCircleOut = (int) getResources().getDimension(com.bupt.heartarea.R.dimen.center_circle_out);
        mCenterCircleMiddle = (int) getResources().getDimension(com.bupt.heartarea.R.dimen.center_circle_middle);
        mCenterCircleInside = (int) getResources().getDimension(com.bupt.heartarea.R.dimen.center_circle_inside);

        mNormalGray = getResources().getColor(com.bupt.heartarea.R.color.normal_gray);

        mIndicatorCenter = getResources().getColor(com.bupt.heartarea.R.color.indicator_center);
        mIndicatorGray = getResources().getColor(com.bupt.heartarea.R.color.indicator_gray);
        mIndicatorLight = getResources().getColor(com.bupt.heartarea.R.color.indicator_light);

        mTitleColor = getResources().getColor(com.bupt.heartarea.R.color.circle_title);
        mAlertColor = getResources().getColor(com.bupt.heartarea.R.color.circle_alert);
        mContentColor = getResources().getColor(com.bupt.heartarea.R.color.circle_content);
        mUnitColor = getResources().getColor(com.bupt.heartarea.R.color.circle_unit);

        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, com.bupt.heartarea.R.styleable.CircleView);
        mDividerWidth = (int) typedArray.getDimension(com.bupt.heartarea.R.styleable.CircleView_circle_out_indicator_size, mDividerWidth);
        mNormalGray = typedArray.getColor(com.bupt.heartarea.R.styleable.CircleView_circle_normal_gray, mNormalGray);

        mOutIndicatorSize = (int) typedArray.getDimension(com.bupt.heartarea.R.styleable.CircleView_circle_out_indicator_size, mOutIndicatorSize);

        mTitleSize = (int) typedArray.getDimension(com.bupt.heartarea.R.styleable.CircleView_circle_title_size, mTitleSize);
        mContentSize = (int) typedArray.getDimension(com.bupt.heartarea.R.styleable.CircleView_circle_content_size, mContentSize);
        mUnitSize = (int) typedArray.getDimension(com.bupt.heartarea.R.styleable.CircleView_circle_unit_size, mUnitSize);
        mAlertSize = (int) typedArray.getDimension(com.bupt.heartarea.R.styleable.CircleView_circle_alert_size, mAlertSize);

        mCenterCircleOut = (int) typedArray.getDimension(com.bupt.heartarea.R.styleable.CircleView_circle_center_out, mCenterCircleOut);
        mCenterCircleMiddle = (int) typedArray.getDimension(com.bupt.heartarea.R.styleable.CircleView_circle_center_middle, mCenterCircleMiddle);
        mCenterCircleInside = (int) typedArray.getDimension(com.bupt.heartarea.R.styleable.CircleView_circle_center_inside, mCenterCircleInside);

        mIndicatorCenter = typedArray.getColor(com.bupt.heartarea.R.styleable.CircleView_circle_indicator_center, mIndicatorCenter);
        mIndicatorGray = typedArray.getColor(com.bupt.heartarea.R.styleable.CircleView_circle_indicator_gray, mIndicatorGray);
        mIndicatorLight = typedArray.getColor(com.bupt.heartarea.R.styleable.CircleView_circle_indicator_light, mIndicatorLight);

        mTitleColor = typedArray.getColor(com.bupt.heartarea.R.styleable.CircleView_circle_title, mTitleColor);
        mAlertColor = typedArray.getColor(com.bupt.heartarea.R.styleable.CircleView_circle_alert, mAlertColor);
        mContentColor = typedArray.getColor(com.bupt.heartarea.R.styleable.CircleView_circle_content, mContentColor);
        mUnitColor = typedArray.getColor(com.bupt.heartarea.R.styleable.CircleView_circle_unit, mUnitColor);
        typedArray.recycle();
    }
